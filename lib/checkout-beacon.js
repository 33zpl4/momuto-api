 ...
 *
 * Lives in lib/ and is served THROUGH /api/lead via a vercel.json rewrite:
 * the Hobby plan caps a deployment at 12 serverless functions and api/ already
 * has exactly 12 — a 13th file in api/ fails the whole deployment. The public
 * URL stays /api/checkout-beacon (the store checkSumbit pages hardcode it).
 *
...
const ALLOWED_ORIGINS = [
  ...
  'https://fr.momuto.com',
  'https://it.momuto.com',
  // us.momuto.com has its own checkSumbit DiyFile (Sep 2026); without it here
  // every US report got a 403 and a broken US handoff left no trace.
  'https://us.momuto.com',
];
